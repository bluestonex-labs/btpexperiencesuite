sap.ui.define([
    ...
    function (Controller, FlattenedDataset, XMLView, View, CoreLibrary, BusyIndicator, MessageBox, HorizontalLayout, VerticalLayout, mobileLibrary, FilterOperator, Filter, Fragment) {
        ...
        return Controller.extend("bsx.btpexperiencesuiteui.controller.EDIT.editUsersRoles", {
            onInit: function () {
                ...
                this.getOwnerComponent().getRouter().getRoute("MANAGEEDIT").attachPatternMatched(this._onRouteMatched, this);
