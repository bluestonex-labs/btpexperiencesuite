		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BTP Experience Suite",
									"targetURL": "#bsxbtpexperiencesuiteui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bsxbtpexperiencesuiteui-display": {
								"semanticObject": "bsxbtpexperiencesuiteui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bsx.btpexperiencesuiteui",
									"url": sap.ui.require.toUrl("bsx/btpexperiencesuiteui")
								}
							}
						}
					}
